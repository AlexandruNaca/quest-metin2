...
quest make_herb_lv15  begin
	...
	state information begin
		when letter begin
			...
			send_letter("&Lv 15 - Cercetarea biologului")
		...
		when __TARGET__.target.click or
			...
			say_title("Biologul Chaegirab:")
			say_verde("")																							
			say_verde("Momentan studiez Radacinile de Gango si am nevoie")
			say_verde("de 20 exemplare care sa nu fie putrede, inteles?")
	...
	state go_to_disciple begin
		...
		when button or info begin
			say_title("Colecteaza Radacini de Gango")
			---                                                   l
			say_verde("")
			say_verde("Biologul Chaegirab student al invatatorului Uriel")
			say_verde("tocmai cerceteaza Radacini de Gango.")
			say_verde("")
			say_verde("Vaneaza "..mob_name(181).." pentru a le obtine")
			say_verde("")
			say_item_vnum(50704) 
		...
		when 181.kill begin
			if pc.count_item(50704)< 20 -pc.getqf("collect_count") then
				pc.give_item2(50704, 1)
			end
		end
		
    	when 20084.chat."Ai Radacina de gango?" with pc.count_item(50704) >0  begin
				say_title("Biologul Chaegirab:")
				say_verde("")
				...
				if s<= pass_percent  then
				   if pc.getqf("collect_count")< 19 then     --20 below
					...
					say_reward("in 100.000 experienta, 30.000 Yang si")
					say_reward("Bratara de argint+6")	
